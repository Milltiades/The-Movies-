...
export default function LoginPage() {
  ...
  const LoginFunc = () => {
    if(localStorage.getItem('email') === getValues('email') && 
       localStorage.getItem('password') === getValues('password')){
      navigate('/user')
    }else{
    ...
    <MainLoginDiv>
      ...
      <LoginDiv>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          ></UnderLine>
          <ButtonLogin type="submit">Login to your account</ButtonLogin>
        </form>
        <DivP>
