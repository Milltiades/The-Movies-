    ...
    items.map((item, index) => {
        return (
          <Recomended key={index}>
            <RecomendedMoive
              img={`url(${movieArray[index].thumbnail.regular.small})`}
            >
              <BookMarkButton
                onClick={() => {
            ...
            <TextDiv>
              <p>{movieArray[index].year}</p>
              <Oval src="/public/assets/Oval.svg" alt="" />
              <img src="" alt="" />
              <p>{movieArray[index].category}</p>
              <Oval src="/public/assets/Oval.svg" alt="" />
              <p>{movieArray[index].rating}</p>
            </TextDiv>
            <TextH1>{movieArray[index].title}</TextH1>
          </Recomended>
        );
      })
  )
