    ...
    items.map((item, index) => {
        return (
          <Recomended key={index}>
            <RecomendedMoive
              img={`url(${TVSeriesArray[index].thumbnail.regular.small})`}
            >
              <BookMarkButton
                onClick={() => {
            ...
            <TextDiv>
              <p>{TVSeriesArray[index].year}</p>
              <Oval src="/public/assets/Oval.svg" alt="" />
              <img src="" alt="" />
              <p>{TVSeriesArray[index].category}</p>
              <Oval src="/public/assets/Oval.svg" alt="" />
              <p>{TVSeriesArray[index].rating}</p>
            </TextDiv>
            <TextH1>{TVSeriesArray[index].title}</TextH1>
          </Recomended>
        );
      })
  )
